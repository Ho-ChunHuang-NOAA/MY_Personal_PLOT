...
while date <= edate:
    for cyc in cycle:
        for ivar in range(0,num_var):
            if flag_obs:
                figdir = figout+"/aqm"+"_"+envir.lower()+"obs_"+date.strftime(YMD_date_format)+"_"+var[ivar]+cyc+BC_append.lower()+"_hrlyp2"
            else:
                figdir = figout+"/aqm"+"_"+envir.lower()+"_"+date.strftime(YMD_date_format)+"_"+var[ivar]+cyc+BC_append.lower()+"_p2"
