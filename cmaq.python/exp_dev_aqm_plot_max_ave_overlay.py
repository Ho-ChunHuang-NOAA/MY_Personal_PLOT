...
working_root=stmp_dir+"/exp_"+envir+"_plot_working_max_ave""
if not os.path.exists(working_root):
    os.mkdir(working_root)

os.chdir(working_root)

msg_file=working_root+"/msg_"+sel_var+"_"+start_date+"_"+sel_cyc
        ...
        for cyc in cycle:
            ...
            for ivar in range(0,num_var):
                ...
                if aqmv7:
                    ...
                    aqmfilein2=usrout+"/aqm."+date.strftime(YMD_date_format)+"/"+cyc+"/"+check_file
                if aqmv6:
    ...
    for cyc in cycle:
        ...
        for ivar in range(0,num_var):
            ...
            if aqmv7:
                ...
                aqmfilein2=usrout+"/aqm."+date.strftime(YMD_date_format)+"/"+cyc+"/"+file_hdr+".grib2"
            if aqmv6:
            ...
            jobid="aqm"+"_"+envir+"_"+date.strftime(YMD_date_format)+"_"+var[ivar]+"obs_"+cycle_time
            figdir = figout+"/"+jobid
