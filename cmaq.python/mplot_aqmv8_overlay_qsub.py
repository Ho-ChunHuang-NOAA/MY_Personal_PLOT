...
if envir == "prod":
    ...
    script_name = [
                  "dev_aqmv8_plot_max_ave_overlay.py",
                  "dev_aqmv8_plot_bc_overlay_p1.py",
                  "dev_aqmv8_plot_bc_overlay_p2.py",
                  "dev_aqmv8_plot_bc_overlay_p3.py",
                  "dev_aqmv8_plot_overlay_p1.py",
                  "dev_aqmv8_plot_overlay_p2.py",
                  "dev_aqmv8_plot_overlay_p3.py"
                  ]
    working_name = [
...
while date <= edate:
    ...
    for cyc in cycle:
        ...
        for i in script_name:
            msg=datetime.datetime.now()
            if i == "dev_aqmv8_plot_max_ave.py":
                ...
                print(msg)
            if i == "dev_aqmv8_plot_max_ave_bc.py":
                print("    Start processing "+i)
                ...
                msg="        python "+i+" "+envir+" "+cyc+" "+YMD+" "+YMD
                print(msg)
            if i in [ "dev_aqmv8_plot_overlay_p1.py", "dev_aqmv8_plot_overlay_p2.py", "dev_aqmv8_plot_overlay_p3.py" ]:
                print("    Start processing "+i)
                if i == "dev_aqmv8_plot_overlay_p1.py" :
                    sec_id="p1"
                if i == "dev_aqmv8_plot_overlay_p2.py" :
                    sec_id="p2"
                if i == "dev_aqmv8_plot_overlay_p3.py" :
                    sec_id="p3"
                for j in var:
                    jobid="plot_"+envir+"obs_"+j+"_"+cyc+"_"+YMD+"_"+sec_id
                    ftpid="ftp_"+envir+"obs_"+j+"_"+cyc+"_"+YMD+"_"+sec_id
                    plot_script=os.path.join(os.getcwd(),jobid+".sh")
                    if os.path.exists(plot_script):
                        os.remove(plot_script)
            ...
            if i in [ "dev_aqmv8_plot_bc_overlay_p1.py", "dev_aqmv8_plot_bc_overlay_p2.py", "dev_aqmv8_plot_bc_overlay_p3.py" ]:
                print("    Start processing "+i)
                if i == "dev_aqmv8_plot_bc_overlay_p1.py" :
                    sec_id="p1"
                if i == "dev_aqmv8_plot_bc_overlay_p2.py" :
                    sec_id="p2"
                if i == "dev_aqmv8_plot_bc_overlay_p3.py" :
                    sec_id="p3"
                for j in var:
                    jobid="plot_"+envir+"bcobs_"+j+"_"+cyc+"_"+YMD+"_"+sec_id
                    ftpid="ftp_"+envir+"bcobs_"+j+"_"+cyc+"_"+YMD+"_"+sec_id
                    plot_script=os.path.join(os.getcwd(),jobid+".sh")
                    if os.path.exists(plot_script):
                        os.remove(plot_script)
                    logfile=log_dir+"/"+jobid+".log"
                    ...
                    subprocess.call(["cat "+plot_script+" | qsub"], shell=True)
                    msg="        python "+i+" "+envir+" "+j+" "+cyc+" "+YMD+" "+YMD
            if i == "dev_aqmv8_plot_max_ave_overlay.py":
                print("    Start processing "+i)
