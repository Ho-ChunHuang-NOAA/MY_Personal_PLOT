...
var=[ "pbl2", "cfrac", "snowc", "veg", "lai" ]
figid=[ "pbl2", "cfrac", "snocov", "veg", "lai" ]
num_var=len(var)
...
find_dir=[
          ...
          "/gpfs/hps3/ptmp/Ho-Chun.Huang/com/aqm/"+envir+".met",
...
while date <= edate:
    sub_met_dir=[
                "aqm."+date.strftime(YMD_date_format),
                "aqm."+date.strftime(YMD_date_format)+".met"
                ]
    flag_find_idir="no"
    ...
    if envir == "prod" or envir == "para6x" or envir == "para6b":
        ...
        for cyc in cycle:
            check_file="aqm."+cyc+".metcro2d.ncf"
            aqmfilein=comout+"/AK."+date.trftime(YMD_date_format)+"/"+check_file
            if os.path.exists(aqmfilein):
                print(aqmfilein+" exists")
            else:
                flag_ak="no"
    ...
    for cyc in cycle:
        ...
        if subdir_marker == "met":
            aqmfilein=comout+"/aqm."+date.strftime(YMD_date_format)+"."+subdir_marker+"/aqm."+cyc+".metcro2d.ncf"
        else:
            aqmfilein=comout+"/aqm."+date.strftime(YMD_date_format)+"/aqm."+cyc+".metcro2d.ncf"
        if os.path.exists(aqmfilein):
            print(aqmfilein+" exists")
        ...
        for ivar in range(0,num_var):
            ...
            figdir = figout+"/aqm"+"_"+envir+"_"+date.strftime(YMD_date_format)+"_"+plot_var+"_"+cyc+"_metv5"
            ...
            if plot_var == "pbl2":
                s3_title="CMAQ ACM2 PBL height (M)"
                scale=1.
                ...
                s3_title="CMAQ NAM PBL height (M)"
                scale=1.
                clevs = [ 250., 500., 1000., 1500., 2000., 2500., 3000., 3500., 4000., 4500. ]
                cbar_num_format = "%.d"
                cmap = mpl.colors.ListedColormap([
                ...
                s3_title="CMAQ Richardson PBL height (M)"
                scale=1.
                clevs = [ 250., 500., 1000., 1500., 2000., 2500., 3000., 3500., 4000., 4500. ]
                cbar_num_format = "%.d"
                cmap = mpl.colors.ListedColormap([
