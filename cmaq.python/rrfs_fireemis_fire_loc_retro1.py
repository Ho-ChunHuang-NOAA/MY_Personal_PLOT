...
reg = [ miss1, "LAfire", "LABasin", miss2, "Mckinney",  "aznw", "dset", "conus", "east", "west",   "ne",   "nw",   "se",   "sw",  "mdn",  "glf",  "lis",   "ak",   "hi",  "can" ]
...
while date <= edate:
    ...
    for cyc in cycle:
        ...
        check_file="Hourly_Emissions_regrid_NA_13km_"+YMD+"_"+cyc+"_h72.nc"
