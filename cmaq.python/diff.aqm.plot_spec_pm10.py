...
if envir1 == "prod":
   var1=[ "pm25_cl", "pm25_ec", "pm25_na", "pm25_mg", "pm25_k", "pm25_ca", "pm25_nh4", "pm25_no3", "pm25_oc", "pm25_soil", "pm25_so4", "pmc_tot" ]
else:
   var1=[ "pm25_cl", "pm25_ec", "pm25_na", "pm25_mg", "pm25_k", "pm25_ca", "pm25_nh4", "pm25_no3", "pm25_oc", "pm25_soil", "pm25_so4", "pm10" ]
if envir2 == "prod":
   var2=[ "pm25_cl", "pm25_ec", "pm25_na", "pm25_mg", "pm25_k", "pm25_ca", "pm25_nh4", "pm25_no3", "pm25_oc", "pm25_soil", "pm25_so4", "pmc_tot" ]
else:
   var2=[ "pm25_cl", "pm25_ec", "pm25_na", "pm25_mg", "pm25_k", "pm25_ca", "pm25_nh4", "pm25_no3", "pm25_oc", "pm25_soil", "pm25_so4", "pm10" ]
figid=[ "pm25_cl", "pm25_ec", "pm25_na", "pm25_mg", "pm25_k", "pm25_ca", "pm25_nh4", "pm25_no3", "pm25_oc", "pm25_soil", "pm25_so4", "pmc_tot" ]
num_var=len(var)
