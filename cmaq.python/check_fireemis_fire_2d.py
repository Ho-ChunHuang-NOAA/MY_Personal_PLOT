...
### PASSED AGRUEMENTS
if len(sys.argv) < 3:
    print("you must set 3 arguments as model_exp [prod|para1...#] cycle [06|12|all] start_date end_date in yyyymmdd")
    sys.exit()
else:
    envir = sys.argv[1]
...
working_dir=ptmp_dir+"/test"
if not os.path.exists(working_dir):
    os.mkdir(working_dir)

working_dir=stmp_dir+"/test"
if not os.path.exists(working_dir):
    os.mkdir(working_dir)
