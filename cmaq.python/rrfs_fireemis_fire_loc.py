...
while date <= edate:
    ...
    for cyc in cycle:
        ...
        if os.path.exists(aqmfilein):
            ...
            mdl_lat = cs_aqm.variables['grid_latt'][:,:]
            mdl_lon = cs_aqm.variables['grid_lont'][:,:]
            i=mdl_lat.shape[0]
            j=mdl_lat.shape[1]
        ...
        for i in range(0,ilen):
            if int(iplot[i]) == 1: 
                ...
                fileout=figout+"/rrfs_fireemisfire."+figarea+"."+envir+"."+date.strftime(YMD_date_format)+".t06z.location.day0.k1.png"
