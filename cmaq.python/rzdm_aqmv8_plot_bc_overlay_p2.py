...
py_code=sys.argv[0]
if py_code.startswith("rzdm_aqmv8_plot_bc_overlay_"):
...
while date <= edate:
    for cyc in cycle:
        for ivar in range(0,num_var):
            figdir = figout+"/aqm"+"_"+EXP.lower()+"obs_"+date.strftime(YMD_date_format)+"_"+var[ivar]+cyc+BC_append.lower()+"_"+fig_sec_id
            ##
