...
while [ ${NOW} -le ${LASTDAY} ]; do
   ...
   if [ ${exp} == 'prod' ]; then
      ...
      comdir=/gpfs/hps2/ptmp/Jianping.Huang/com/aqm/para5/aqm.${NOW}
      comdir=/gpfs/dell2/ptmp/${USER}/para5/aqm.${NOW}
   elif [ ${exp} == 'para8' ]; then
      comdir=/gpfs/hps2/ptmp/Jianping.Huang/com/aqm/para8/aqm.${NOW}
      comdir=/gpfs/dell2/ptmp/${USER}/para8/aqm.${NOW}
   else
