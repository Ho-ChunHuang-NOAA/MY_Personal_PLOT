...
ftpdir=/gpfs/dell2/stmp/${USER}/daily_plot_aqm_emis
mkdir -p ${ftpdir}
...
while [ ${NOW} -le ${LASTDAY} ]; do
   ...
   if [ ${exp1} == 'prod' ]; then
      comdir1=${COMROOTp2}/aqm/${exp1}/aqm.${NOW}
      ## comdir12=/gpfs/${phase12_id}d1/emc/meso/noscrub/${USER}/com/aqm/${exp1}/aqm.${NOW}
      comdir12=/gpfs/${phase12_id}d1/emc/meso/noscrub/${USER}/com/
      comdir1=/gpfs/hps/nco/ops/com/aqm/${exp1}/aqm.${NOW}
      ## comdir12=/gpfs/hps3/emc/naqfc/noscrub/${USER}/com/aqm/${exp1}/aqm.${NOW}
      ## comdir12=/gpfs/hps3/emc/meso/noscrub/${USER}/com/aqm/${exp1}/aqm.${NOW}
      if [ ! -d ${comdir1} ]; then
         if [ -d ${comdir12} ]; then
            comdir1=${comdir12}
         else
      ...
      comdir1=${COMROOTp2}/aqm/${exp1}/aqm.${NOW}
      comdir1=/gpfs/hps/nco/ops/com/aqm/${exp1}/aqm.${NOW}
      comdir1=/naqfc/noscrub/Jianping.Huang/com/aqm/${exp1}/aqm.${NOW}
   elif [ ${exp1} == 'para1' ]; then
      ## comdir1=/ptmpp1/Jianping.Huang/com/aqm/${exp1}/aqm.${NOW}
      comdir1=/gpfs/hps3/emc/naqfc/noscrub/${USER}/com/aqm/${exp1}/aqm.${NOW}
   elif [ ${exp1} == 'para2' ]; then
      ## comdir1=/ptmpp1/Jianping.Huang/com/aqm/${exp1}/aqm.${NOW}
      ## comdir1=/naqfc/noscrub/Jianping.Huang/com/aqm/${exp1}/aqm.${NOW}
      comdir1=/gpfs/hps3/emc/naqfc/noscrub/${USER}/com/aqm/${exp1}/aqm.${NOW}
   elif [ ${exp1} == 'para5' ]; then
      comdir1=/gpfs/${phase12_id}d1/emc/meso/noscrub/Ho-Chun.Huang/cmaq_emiss_tmp/${exp1}/aqm.${NOW}
   elif [ ${exp1} == 'para8' ]; then
      comdir1=/gpfs/${phase12_id}d1/emc/meso/noscrub/Ho-Chun.Huang/cmaq_emiss_tmp/${exp1}/aqm.${NOW}
   else
      comdir1=/gpfs/${phase12_id}d1/emc/meso/noscrub/Ho-Chun.Huang/cmaq_emiss_tmp/${exp1}/aqm.${NOW}
   fi
   if [ ${exp2} == 'prod' ]; then
      comdir2=${COMROOTp2}/aqm/${exp2}/aqm.${NOW}
      ## comdir22=/gpfs/${phase12_id}d1/emc/meso/noscrub/${USER}/com/aqm/${exp2}/aqm.${NOW}
      comdir22=/gpfs/${phase12_id}d1/emc/meso/noscrub/${USER}/com/
      comdir2=/gpfs/hps/nco/ops/com/aqm/${exp2}/aqm.${NOW}
      ## comdir22=/gpfs/hps3/emc/naqfc/noscrub/${USER}/com/aqm/${exp2}/aqm.${NOW}
      ## comdir22=/gpfs/hps3/emc/meso/noscrub/${USER}/com/aqm/${exp2}/aqm.${NOW}
      if [ ! -d ${comdir2} ]; then
         if [ -d ${comdir22} ]; then
            comdir2=${comdir22}
         else
      ...
      comdir2=${COMROOTp2}/aqm/${exp2}/aqm.${NOW}
      comdir2=/gpfs/hps/nco/ops/com/aqm/${exp2}/aqm.${NOW}
      comdir2=/naqfc/noscrub/Jianping.Huang/com/aqm/${exp2}/aqm.${NOW}
   elif [ ${exp2} == 'para1' ]; then
      ## comdir2=/ptmpp1/Jianping.Huang/com/aqm/${exp2}/aqm.${NOW}
      comdir2=/gpfs/hps3/emc/naqfc/noscrub/${USER}/com/aqm/${exp2}/aqm.${NOW}
   elif [ ${exp2} == 'para2' ]; then
      ## comdir2=/ptmpp1/Jianping.Huang/com/aqm/${exp2}/aqm.${NOW}
      ## comdir2=/naqfc/noscrub/Jianping.Huang/com/aqm/${exp2}/aqm.${NOW}
      comdir2=/gpfs/hps3/emc/naqfc/noscrub/${USER}/com/aqm/${exp2}/aqm.${NOW}
   elif [ ${exp2} == 'para5' ]; then
      comdir2=/gpfs/${phase12_id}d1/emc/meso/noscrub/Ho-Chun.Huang/cmaq_emiss_tmp/${exp2}/aqm.${NOW}
   elif [ ${exp2} == 'para8' ]; then
      comdir2=/gpfs/${phase12_id}d1/emc/meso/noscrub/Ho-Chun.Huang/cmaq_emiss_tmp/${exp2}/aqm.${NOW}
   else
      comdir2=/gpfs/${phase12_id}d1/emc/meso/noscrub/Ho-Chun.Huang/cmaq_emiss_tmp/${exp2}/aqm.${NOW}
   fi
   ...
   for cych in "${cyc_opt[@]}"; do
      ...
      for jfile in "${type[@]}"
      do
         tmpdir=/gpfs/dell2/stmp/${USER}/com2_aqm_${exp1}_${exp2}_${jfile}.${NOW}${cych}
         if [ -d ${tmpdir} ]; then
            /bin/rm -f ${tmpdir}/*
         else
            mkdir -p ${tmpdir}
...
'printim ${outdir}/aqm.vpro.${exp1}.${NOW}.${cychr}.poc.k1_13.gif gif x500 y800 white'
'c'
'quit'
EOF
echo ${outdir}
