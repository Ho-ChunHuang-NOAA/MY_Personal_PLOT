...
start = date(2019,8,1) # June 1, 2019 (2019,6,1)
end = date(2019,8,31) # June 28, 2019 (2019,6,28)
...
ax3.set_title('Time Series: Aug. 1-31, 2019 (Southeast U.S.)',fontsize='14')
...
ax4.set_title('Time Series: Aug. 1-31, 2019 (Southeast U.S.)',fontsize='14')
...
for v in var_all:
    ...
    plt.axhline(y=0, color='k', linestyle='-')
    ax3.set_title('Time Series (Southeast U.S.) | Initial Time: 2019-08-16 12z',fontsize='12')
...
#lat_box = airnow[19]['LAT']
#lon_box = airnow[19]['LON']
#print(lat_box)
...
#for md in ['FV3']:
    ...
    ax2.set_title('%s-CMAQ | Initial Time: 2019-08-20 12z | Southeast U.S.'%md,fontsize=14)
