...
var=[ "pbl2", "rn", "rc", "rgrnd", "cfrac", "cfracp", "snowc", "veg", "lai" ]
var2=[ "pbl", "rn", "rc", "rgrnd", "cfrac", "cfracp", "snocov", "veg", "lai" ]
...
while date <= edate:
    for cyc in cycle:
        ...
        if os.path.exists(aqmfilein):
            ...
            aqmfilein=usrout1+"/aqm."+date.strftime(YMD_date_format)+"/aqm."+cyc+".metcro2d.ncf"
            if os.path.exists(aqmfilein):
                print(aqmfilein+" exists")
                cs_aqm1 = netcdf.Dataset(aqmfilein)
                cs_var = cs_aqm1.variables['TFLAG'][:,0,:]
        ...
        aqmfilein=comout2+"/aqm."+date.strftime(YMD_date_format)+".met/aqm."+cyc+".metcro2d.ncf"
        if os.path.exists(aqmfilein):
            print(aqmfilein+" exists")
            ...
            aqmfilein=usrout2+"/aqm."+date.strftime(YMD_date_format)+".met/aqm."+cyc+".metcro2d.ncf"
            if os.path.exists(aqmfilein):
                print(aqmfilein+" exists")
                cs_aqm2 = netcdf.Dataset(aqmfilein)
                cs_var = cs_aqm2.variables['TFLAG'][:,0,:]
        ...
        if flag_ak == "yes":
            ...
            if os.path.exists(aqmfilein):
                ...
                aqmfilein=usrout1+"/AK."+date.strftime(YMD_date_format)+"/aqm."+cyc+".metcro2d.ncf"
                if os.path.exists(aqmfilein):
                    print(aqmfilein+" exists")
                    ak_aqm1 = netcdf.Dataset(aqmfilein)
                    ak_var = ak_aqm1.variables['TFLAG'][:,0,:]
            ...
            aqmfilein=comout2+"/AK."+date.strftime(YMD_date_format)+".met/aqm."+cyc+".metcro2d.ncf"
            if os.path.exists(aqmfilein):
                print(aqmfilein+" exists")
                ...
                aqmfilein=usrout2+"/AK."+date.strftime(YMD_date_format)+".met/aqm."+cyc+".metcro2d.ncf"
                if os.path.exists(aqmfilein):
                    print(aqmfilein+" exists")
                    ak_aqm2 = netcdf.Dataset(aqmfilein)
                    ak_var = ak_aqm2.variables['TFLAG'][:,0,:]
        ...
        if flag_hi == "yes":
            ...
            if os.path.exists(aqmfilein):
                ...
                aqmfilein=usrout1+"/HI."+date.strftime(YMD_date_format)+"/aqm."+cyc+".metcro2d.ncf"
                if os.path.exists(aqmfilein):
                    print(aqmfilein+" exists")
                    hi_aqm1 = netcdf.Dataset(aqmfilein)
                    hi_var = hi_aqm1.variables['TFLAG'][:,0,:]
            ...
            aqmfilein=comout2+"/HI."+date.strftime(YMD_date_format)+".met/aqm."+cyc+".metcro2d.ncf"
            if os.path.exists(aqmfilein):
                print(aqmfilein+" exists")
                ...
                aqmfilein=usrout2+"/HI."+date.strftime(YMD_date_format)+".met/aqm."+cyc+".metcro2d.ncf"
                if os.path.exists(aqmfilein):
                    print(aqmfilein+" exists")
                    hi_aqm2 = netcdf.Dataset(aqmfilein)
                    hi_var = hi_aqm2.variables['TFLAG'][:,0,:]
