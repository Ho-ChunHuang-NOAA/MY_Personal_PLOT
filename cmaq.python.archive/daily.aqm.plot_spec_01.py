...
while date <= edate:
    for cyc in cycle:
        ...
        for ivar in range(0,num_var):
            ...
            figdir = figout+"/aqm"+"_"+envir+"_"+date.strftime(YMD_date_format)+"_"+plot_var+"_"+cyc
            ...
            for n in range(nstep-1,nstep):
                ...
                for ireg in range(0,num_reg):
                    if iplot[ireg] == 1:
                        ...
                        savefig_name = figdir+"/aqm."+figarea+"."+envir.lower()+"."+date.strftime(YMD_date_format)+"."+cyc+"."+str(format(nout,'02d'))+"."+plot_var+".k1.png"
