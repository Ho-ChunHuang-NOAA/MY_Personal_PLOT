...
if envir1 != envir2:
   ...
   sys.exit()
    ...
    title_id=envir1.upper()+"BC-"+envir1.upper()
    fig_id=envir1.lower()+"bc-"+envir1.lower()
    ...
    for cyc in cycle:
        ...
        if flag_ak == "yes":
            ...
            if os.path.exists(model_filein):
                print(model_filein+" exists")
                model_data = netcdf.Dataset(model_filein)
                ## ak_lat = model_data.variables['ROW'][:,:]
                ## ak_lon = model_data.variables['COL'][:,:]
        ...
        if flag_hi == "yes":
            ...
            if os.path.exists(model_filein):
                print(model_filein+" exists")
                model_data = netcdf.Dataset(model_filein)
                ## hi_lat = model_data.variables['ROW'][:,:]
                ## hi_lon = model_data.variables['COL'][:,:]
        ...
        for ivar in range(0,num_var):
            ...
            figdir = figout+"/aqm"+"_"+envir1+"_"+date.strftime(YMD_date_format)+"_"+var[ivar]+"_"+cyc+"_diffbc"
