...
DATA = '/gpfs/dell2/stmp/Ho-Chun.Huang'
## RUN = os.environ['RUN']
RUN = 'plotcmaq_py'
...
model_lat_lon_netcdf_dir = '/gpfs/dell2/emc/modeling/noscrub/Ho-Chun.Huang/cmaq_python_data'
lat_lon_file = 'aqm.t12z.grddot2d.ncf'
model_lat_lon_netcdf_file = os.path.join(model_lat_lon_netcdf_dir,lat_lon_file)
if os.path.exists(model_lat_lon_netcdf_file):
    print(model_lat_lon_netcdf_file+" exists")
    model_data = netcdf.Dataset(model_lat_lon_netcdf_file)
