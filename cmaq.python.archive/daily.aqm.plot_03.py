...
while date <= edate:
    for cyc in cycle:
        ...
        if os.path.exists(aqmfilein):
            ...
            aqmfilein=usrout+"/aqm."+date.strftime(YMD_date_format)+"/aqm."+cyc+".aconc_sfc.ncf"
            if os.path.exists(aqmfilein):
                print(aqmfilein+" exists")
                cs_aqm = netcdf.Dataset(aqmfilein)
                cs_var = cs_aqm.variables['TFLAG'][:,0,:]
        ...
        if flag_ak == "yes":
            ...
            if os.path.exists(aqmfilein):
                ...
                aqmfilein=usrout+"/AK."+date.strftime(YMD_date_format)+"/aqm."+cyc+".aconc_sfc.ncf"
                if os.path.exists(aqmfilein):
                    print(aqmfilein+" exists")
                    ak_aqm = netcdf.Dataset(aqmfilein)
                    ak_var = ak_aqm.variables['TFLAG'][:,0,:]
        ...
        if flag_hi == "yes":
            ...
            if os.path.exists(aqmfilein):
                ...
                aqmfilein=usrout+"/HI."+date.strftime(YMD_date_format)+"/aqm."+cyc+".aconc_sfc.ncf"
                if os.path.exists(aqmfilein):
                    print(aqmfilein+" exists")
                    hi_aqm = netcdf.Dataset(aqmfilein)
                    hi_var = hi_aqm.variables['TFLAG'][:,0,:]
