...
while date <= edate:
    for cyc in cycle:
        ...
        if os.path.exists(aqmfilein):
            ...
            for ivar in range(0,num_var):
                if var[ivar] == "o3":
                    o3_cs2 = cs_aqm.variables['O3'][:,0,:,:]*1000.
                elif var[ivar] == "pm25":
                    pm_cs2 = cs_aqm.variables['PM25_TOT'][:,0,:,:]
            cs_aqm.close()
        else:
        ...
        if flag_ak == "yes":
            ...
            if os.path.exists(aqmfilein):
                ...
                for ivar in range(0,num_var):
                    if var[ivar] == "o3":
                        o3_ak2 = ak_aqm.variables['O3'][:,0,:,:]*1000.
                    elif var[ivar] == "pm25":
                        pm_ak2 = ak_aqm.variables['PM25_TOT'][:,0,:,:]
                ak_aqm.close()
            else:
        ...
        if flag_hi == "yes":
            ...
            if os.path.exists(aqmfilein):
                ...
                for ivar in range(0,num_var):
                    if var[ivar] == "o3":
                        o3_hi2 = hi_aqm.variables['O3'][:,0,:,:]*1000.
                    elif var[ivar] == "pm25":
                        pm_hi2 = hi_aqm.variables['PM25_TOT'][:,0,:,:]
                hi_aqm.close()
            else:
        ...
        for ivar in range(0,num_var):
            ...
            figdir = figout+"/aqm"+"_"+envir1+"_"+date.strftime(YMD_date_format)+"_"+var[ivar]+"_"+cyc+"_diff"
