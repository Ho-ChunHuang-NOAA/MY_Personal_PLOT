...
# Create WS NMB time series plot
...
ax3.set_title('Time Series: Aug. 2019 (CONUS)',fontsize='14')
...
# Create WS NME time series plot
...
ax4.set_title('Time Series: Aug. 2019 (CONUS)',fontsize='14')
...
# Create WS RMSE time series plot
...
ax5.set_title('Time Series: Aug. 2019 (CONUS)',fontsize='14')
...
# Create WS R^2 time series plot
...
ax6.set_title('Time Series: Aug. 2019 (CONUS)',fontsize='14')
...
for mo in mesonet_obs:
    # Load NumPy array
    print(mo)
    mesonet = np.load(d_str3+mo,allow_pickle=True).flat[0]
