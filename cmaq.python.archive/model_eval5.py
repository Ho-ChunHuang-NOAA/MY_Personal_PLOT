...
ending = '201908072359'# 201906102359

# Enter mesonet station variables names, network name, and bounding box limits 
# https://developers.synopticdata.com/mesonet/v2/api-variables/
#variables = 'air_temp,relative_humidity,wind_speed,wind_direction,weather_condition'
...
for v in var_all:
    ...
    ax3.set_title('Time Series (CONUS) | Initial Time: 2019-08-20 12z',fontsize='14')
...
print("The plotting with model_eval5.py is finished!")
