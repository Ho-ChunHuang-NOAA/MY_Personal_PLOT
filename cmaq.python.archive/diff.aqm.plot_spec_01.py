...
title_id=envir2.upper()+"-"+envir1.upper()
fig_id=envir2.lower()+"-"+envir1.lower()
...
var=[ "pm25_cl", "pm25_ec", "pm25_na", "pm25_mg", "pm25_k", "pm25_ca", "pm25_nh4", "pm25_no3", "pm25_oc", "pm25_soil", "pm25_so4", "pmc_tot" ]
num_var=len(var)
...
##
if envir1 == "prod":
    comout1="/gpfs/hps/nco/ops/com/aqm/"+envir1
    usrout1="/gpfs/hps/nco/ops/com/aqm/"+envir1
    metout1=comout1
    flag_ak = "yes"
    flag_hi = "yes"
elif envir1 == "para6":
    ## comout1="/gpfs/hps3/emc/naqfc/noscrub/Ho-Chun.Huang/com/aqm"+envir1
    comout1="/gpfs/hps3/ptmp/Ho-Chun.Huang/com/aqm/"+envir1
    usrout1="/gpfs/hps3/emc/naqfc/noscrub/Ho-Chun.Huang/com/aqm/"+envir1
    metout1="/gpfs/hps/nco/ops/com/aqm/prod"
    flag_ak = "no"
    flag_hi = "no"
else:
    comout1="/gpfs/dell2/emc/modeling/noscrub/Ho-Chun.Huang/com/aqm/"+envir1
    usrout1="/gpfs/hps3/emc/naqfc/noscrub/Ho-Chun.Huang/com/aqm/"+envir1
    metout1="/gpfs/hps/nco/ops/com/aqm/prod"
    flag_ak = "no"
    flag_hi = "no"
...
if envir2 == "prod":
    comout2="/gpfs/hps/nco/ops/com/aqm/"+envir2
    usrout2="/gpfs/hps/nco/ops/com/aqm/"+envir2
    metout2=comout2
elif envir2 == "para6":
    ## comout2="/gpfs/hps3/emc/naqfc/noscrub/Ho-Chun.Huang/com/aqm"+envir2
    comout2="/gpfs/hps3/ptmp/Ho-Chun.Huang/com/aqm/"+envir2
    usrout2="/gpfs/hps3/emc/naqfc/noscrub/Ho-Chun.Huang/com/aqm/"+envir2
    metout2="/gpfs/hps/nco/ops/com/aqm/prod"
    flag_ak = "no"
    flag_hi = "no"
else:
    comout2="/gpfs/dell2/emc/modeling/noscrub/Ho-Chun.Huang/com/aqm/"+envir2
    usrout2="/gpfs/hps3/emc/naqfc/noscrub/Ho-Chun.Huang/com/aqm/"+envir2
    metout2="/gpfs/hps/nco/ops/com/aqm/prod"
    flag_ak = "no"
    flag_hi = "no"
...
while date <= edate:
    for cyc in cycle:
        ...
        if os.path.exists(aqmfilein):
            ...
            nstep2=len(cs_var)
            if nstep2 != nstep:
                print("time step of "+envir2+" CONUS domain "+nstep2+" is different from "+envir1+" CONUS domain "+nstep)
                sys.exit()
        else:
            aqmfilein=usrout2+"/aqm."+date.strftime(YMD_date_format)+"/aqm."+cyc+".aconc_sfc.ncf"
            if os.path.exists(aqmfilein):
                print(aqmfilein+" exists")
                cs_aqm2 = netcdf.Dataset(aqmfilein)
                cs_var = cs_aqm2.variables['TFLAG'][:,0,:]
        ...
        if flag_ak == "yes":
            ...
            if os.path.exists(aqmfilein):
                ...
                nstep_ak=len(ak_var)
                if nstep_ak != nstep:
                    print("time step of AK domain "+nstep_ak+" is different from CONUS domain "+nstep)
                    sys.exit()
            else:
            ...
            if os.path.exists(aqmfilein):
                ...
                aqmfilein=usrout2+"/AK."+date.strftime(YMD_date_format)+"/aqm."+cyc+".aconc_sfc.ncf"
                if os.path.exists(aqmfilein):
                    print(aqmfilein+" exists")
                    ak_aqm2 = netcdf.Dataset(aqmfilein)
                    ak_var = ak_aqm2.variables['TFLAG'][:,0,:]
        ...
        if flag_hi == "yes":
            ...
            if os.path.exists(aqmfilein):
                ...
                nstep_hi= nstep
                if nstep_hi != nstep:
                    print("time step of HI domain "+nstep_hi+" is different from CONUS domain "+nstep)
                    sys.exit()
            else:
            ...
            if os.path.exists(aqmfilein):
                ...
                aqmfilein=usrout2+"/HI."+date.strftime(YMD_date_format)+"/aqm."+cyc+".aconc_sfc.ncf"
                if os.path.exists(aqmfilein):
                    print(aqmfilein+" exists")
                    hi_aqm2 = netcdf.Dataset(aqmfilein)
                    hi_var = hi_aqm2.variables['TFLAG'][:,0,:]
        ...
        for ivar in range(0,num_var):
            ...
            figdir = figout+"/aqm"+"_"+envir1+"_"+date.strftime(YMD_date_format)+"_"+plot_var+"_"+cyc+"_diff"
            ...
            var_cs1 = cs_aqm1.variables[read_var][:,0,:,:]*scale
            var_cs2 = cs_aqm2.variables[read_var][:,0,:,:]*scale
            if flag_ak == "yes":
                var_ak1 = ak_aqm1.variables[read_var][:,0,:,:]*scale
                var_ak2 = ak_aqm2.variables[read_var][:,0,:,:]*scale
            if flag_hi == "yes":
                var_hi1 = hi_aqm1.variables[read_var][:,0,:,:]*scale
                var_hi2 = hi_aqm2.variables[read_var][:,0,:,:]*scale
