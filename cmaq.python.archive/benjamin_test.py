...
end = date(2019,6,25) # June 28, 2019 (2019,6,28)
...
lat_box = list(airnow[19]['LAT'])
lon_box = list(airnow[19]['LON'])
print(lon_box)
#exit()
#lat_box = airnow[10]['LAT']
#lon_box = airnow[10]['LON']
