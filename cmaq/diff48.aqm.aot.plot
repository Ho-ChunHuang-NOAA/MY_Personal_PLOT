...
mydir3=/gpfs/dell2/emc/modeling/noscrub/${USER}/com/aqm/${exp1}
...
mydir3=/gpfs/dell2/emc/modeling/noscrub/${USER}/com/aqm/${exp2}
...
while [ ${NOW} -le ${LASTDAY} ]; do
   ...
   for cych in "${cyc_opt[@]}"; do
      ...
      outdir=/gpfs/dell1/stmp/${USER}/daily_plot_aot/aqm_${exp}_pm_aot.${NOW}${cych}
...
EOF
   ...
   while [ ${NOW} -le ${LASTDAY} ]; do
      ...
      for i in "${cyc[@]}"; do
         cycle=t${i}z
         data_dir=/gpfs/dell1/stmp/${USER}/daily_plot_aot/aqm_${exp}_pm_aot.${NOW}${i}
         if [ -d ${data_dir} ]; then
