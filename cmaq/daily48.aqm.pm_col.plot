...
case ${sel_cyc} in
   ''|*[!0-9]*) if [ "${sel_cyc}" == "all" ]; then
            ...
            echo "input choice for cycle time is not defined ${sel_cyc}, program stop"
            echo $MSG
            exit
         fi ;;
...
EOF
            ...
            while [ ${numi} -le ${t1} ]; do
               ...
               ## older version of cmaq include IC as f01 and FCST 72hr as f49
