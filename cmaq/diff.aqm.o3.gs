...
'd OZCONsig1000.2-OZCONsig1000.1'
gdir'/cbar.gs'
'draw title 'exp' 'days' 'cyclhr'\'vldhr' Ozone sfc_conc (ppbV)'
if(area='st')
'draw.cmaq.box.st.gs'
endif
'printim 'odir'/aqm.'area'.'run'.'days'.'cyclhr'.'fcsthr'.o3.k1.png png x'xsize' y'ysize' white'
'c'
