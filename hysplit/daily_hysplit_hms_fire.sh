#!/bin/sh
#PBS -o /lfs/h2/emc/ptmp/${USER}/batch_logs/hyspt_hms_fire_20170414.out
#PBS -e /lfs/h2/emc/ptmp/${USER}/batch_logs/hyspt_hms_fire_20170414.err
#PBS -l place=shared,select=1:ncpus=1:mem=4GB
#PBS -N jhyspt_hms_fire
#PBS -q dev_transfer
#PBS -A AQM-DEV
