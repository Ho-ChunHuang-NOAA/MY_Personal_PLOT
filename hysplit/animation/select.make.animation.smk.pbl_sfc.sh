   ...
   do
      ...
      do
         ...
         do
            ...
            anim_file=hysplit_${i}_$NOW.anim.${j}.${L}.${beg_hour}_${end_hour}.gif
            convert -delay ${anim_time} -loop 0 hysplit${i}smoke${j}_*_${L}.gif ${anim_file}
            mv ${anim_file} ${odir}
         done
      done
   done
