...
datadir = '/gpfs/dell2/emc/modeling/noscrub/${USER}/aod_smoke/fire_prod'
working_dir="/gpfs/dell1/stmp/${USER}/working/hms/"+envir
date = sdate
while date <= edate:
    ...
    ##ax = plt.axes(projection=ccrs.LambertConformal(central_longitude=-96.0, central_latitude=39.0, false_easting=0.0, false_northing=0.0, secant_latitudes=None, standard_parallels=None, globe=None, cutoff=-30)
        ...
        for i in range(0,ilen):
            if int(iplot[i]) == 1: 
                ...
                ax = plt.axes(projection=ccrs.LambertConformal(central_longitude=clon, central_latitude=clat, false_easting=-58.775, false_northing=48.772, standard_parallels=(33, 45), globe=None))
                ...
                ax.set_title(date.strftime(YMD_date_format)+" model run fire location")
                ...
                fileout=figout+"/hmsfire."+figarea+"."+envir+"."+date.strftime(YMD_date_format)+".t06z.location.day0.k1.png"
