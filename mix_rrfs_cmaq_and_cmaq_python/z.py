...
if envir == "prod":
    script_name = [
                  ...
                  "daily.aqm.plot_met_v5.py", "diff.aqm.plot_bc.py", "daily.aqm.col_v5.py"
                  ]
    col_var = [ "pm25_col" ]
else:
    script_name = [
...
##                  "diff.aqm.plot_met_v6.py", "diff.aqm.plot_met_v5_6.py"
        ...
        for i in script_name:
            ...
            if i == "diff.aqm.plot_48vs72.py" and envir != "prod":
                ...
                for j in var:
                    ...
                    print(msg)
                    subprocess.call(["python "+i+" prod "+envir+" "+j+" "+cyc+" "+date.strftime(YMD_date_format)+" "+date.strftime(YMD_date_format)+" > "+i+".prod-"+envir+"."+j+"."+cyc+"."+date.strftime(YMD_date_format)+".log 2>&1 &"], shell=True)
            if i == "diff.aqm.plot.py" and envir == "para6z":
                print("    Start processing "+i)
                for j in var:
                    msg="        python "+i+" para6x "+envir+" "+j+" "+cyc+" "+date.strftime(YMD_date_format)+" "+date.strftime(YMD_date_format)
                    print(msg)
                    subprocess.call(["python "+i+" para6x "+envir+" "+j+" "+cyc+" "+date.strftime(YMD_date_format)+" "+date.strftime(YMD_date_format)+" > "+i+"."+envir+"-para6a."+j+"."+cyc+"."+date.strftime(YMD_date_format)+".log 2>&1 &"], shell=True)
            if i == "daily.aqm.plot_met_v5.py" and envir == "prod":
                print("    Start processing "+i)
                msg="        python "+i+" "+envir+" "+cyc+" "+date.strftime(YMD_date_format)+" "+date.strftime(YMD_date_format)
                print(msg)
                subprocess.call(["python "+i+" "+envir+" "+cyc+" "+date.strftime(YMD_date_format)+" "+date.strftime(YMD_date_format)+" > "+i+"."+envir+"."+cyc+"."+date.strftime(YMD_date_format)+".log 2>&1 &"], shell=True)
            if i == "daily.aqm.plot_met_v6.py" and envir != "prod":
                print("    Start processing "+i)
                msg="        python "+i+" "+envir+" "+cyc+" "+date.strftime(YMD_date_format)+" "+date.strftime(YMD_date_format)
                print(msg)
                subprocess.call(["python "+i+" "+envir+" "+cyc+" "+date.strftime(YMD_date_format)+" "+date.strftime(YMD_date_format)+" > "+i+"."+envir+"."+cyc+"."+date.strftime(YMD_date_format)+".log 2>&1 &"], shell=True)
            if i == "diff.aqm.plot_met_v5_6.py" and envir != "prod":
                print("    Start processing "+i)
                msg="        python "+i+" prod "+envir+" "+cyc+" "+date.strftime(YMD_date_format)+" "+date.strftime(YMD_date_format)
                print(msg)
                subprocess.call(["python "+i+" prod "+envir+" "+cyc+" "+date.strftime(YMD_date_format)+" "+date.strftime(YMD_date_format)+" > "+i+"."+envir+"-prod."+cyc+"."+date.strftime(YMD_date_format)+".log 2>&1 &"], shell=True)
            if i == "diff.aqm.plot_met_v6.py" and envir == "para6z":
                print("    Start processing "+i)
            ...
            if i == "daily.aqm.plot_fireemis_r.py" and envir != "prod":
                ...
                for j in var:
                    ...
                    print(msg)
                    subprocess.call(["python "+i+" "+envir+" "+cyc+" "+date.strftime(YMD_date_format)+" "+date.strftime(YMD_date_format)+" > "+i+"."+envir+"."+cyc+"."+date.strftime(YMD_date_format)+".log 2>&1 &"], shell=True)
            if i == "daily.aqm.plot_dustloc.py" and envir != "prod":
                print("    Start processing "+i)
                for j in var:
                    msg="        python "+i+" "+envir+" "+cyc+" "+date.strftime(YMD_date_format)+" "+date.strftime(YMD_date_format)
                    print(msg)
