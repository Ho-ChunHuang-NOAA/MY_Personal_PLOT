...
old_ver='module load met/9.0.2'
new_ver='module load met/9.1'
old_ver='modulefiles\/modulefiles'
old_er='\/\/modulefiles'
old_ver='module load met/9.1'
new_ver='module load met/10_beta2'
old_ver='Julie.Prestopnik\/modulefiles'
old_ver='noscrub\/modulefiles'
new_ver='noscrub\/emc.metplus\/modulefiles'
old_ver='\/gpfs\/dell2\/stmp'
new_ver='\/gpfs\/dell1\/stmp'
old_ver='\/gpfs\/dell2\/ptmp'
new_ver='\/gpfs\/dell1\/ptmp'
old_ver='\-q "dev2_transfer"'
new_ver='\-q "dev_transfer"'
old_ver='module load prod_util/1.1.4'
new_ver='module load prod_util/1.1.6'
old_ver='prod_envir\/1.0.3'
